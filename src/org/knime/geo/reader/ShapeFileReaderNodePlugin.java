 ...
 * @author Forkan
 */
public class ShapeFileReaderNodePlugin extends Plugin {
    // The shared instance.
    private static ShapeFileReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public ShapeFileReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ShapeFileReaderNodePlugin getDefault() {
        return plugin;
    }
